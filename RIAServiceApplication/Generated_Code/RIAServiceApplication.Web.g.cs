...
namespace RIAServiceApplication.Web
{
    ...
    public sealed partial class AuthenticationContext : global::System.ServiceModel.DomainServices.Client.ApplicationServices.AuthenticationDomainContextBase
    {
        ...
        public AuthenticationContext() : 
                this(new WebDomainClient<IAuthenticationServiceContract>(new Uri("RIAServiceApplication-Web-AuthenticationService.svc", UriKind.Relative)))
        {
        }
    ...
    /// </summary>
    [DataContract(Namespace="http://schemas.datacontract.org/2004/07/RIAServiceApplication.Web")]
    ...
    public sealed partial class UserRegistrationContext : DomainContext
    {
        ...
        public UserRegistrationContext() : 
                this(new WebDomainClient<IUserRegistrationServiceContract>(new Uri("RIAServiceApplication-Web-UserRegistrationService.svc", UriKind.Relative)))
        {
        }
