namespace RIAServiceApplication.Web
{
    using System.ComponentModel.DataAnnotations;
    using RIAServiceApplication.Web.Resources;
    ...
    public sealed partial class RegistrationData
    {
        ...
        [CustomRegularExpression("^[a-zA-Z0-9_]*$", ErrorMessageResourceName = "ValidationErrorInvalidUserName", ErrorMessageResourceType = typeof(ValidationErrorResources))]
        ...
        [CustomRegularExpression(@"^([\w-\.]+)@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.)|(([\w-]+\.)+))([a-zA-Z]{2,4}|[0-9]{1,3})(\]?)$",
